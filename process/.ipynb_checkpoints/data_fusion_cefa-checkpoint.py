...
from utils import *
from process.augmentation_cefa import *
from process.data_helper_cefa import *


class FDDataset_cefa(Dataset):
    def __init__(self, mode, dataset_name,sample_type='all', modality='color', fold_index='<NIL>', image_size=128, augment = None, balance = True, crop=True, gray=True):
        super(FDDataset_cefa, self).__init__()
    ...
    def __getitem__(self, index,domain_label=1):
...
def run_check_train_data():
    dataset = FDDataset_cefa(mode = 'val',dataset_name='4@1')
    print(dataset)
